...
public class DynamicPlayProviderTest {
    ...
    LibraryArtifact libraryArtifact = LibraryArtifact.Companion.fromName("mysql:mysql-connector-java:5.10");
    Recipe recipe;
    DynamicPlayProvider playProvider;
    @Before
    public void setup() throws IOException {
        String yaml = IOUtils.toString(ClassLoader.getSystemResourceAsStream("example.yml"));
        ObjectMapper mapper = Mappers.yamlMapper;
    ...
    public void detectsPlaceholdersInRoles() {
        ...
        playProvider.provideRoles(libraryArtifact,configuration);
    ...
    @Test
    public void matchesAgainstDeclaredResolutions() {
        assertThat(playProvider.canProvideFor(libraryArtifact), is(true));
    }
}
